...
<head>
    ...
    <title><?php echo $productNames['products3']; ?> | Shop</title>
</head>
        ...
        <div class="container">
            <div class="breadcrumbs">
                <div>
                    ...
                    <span>/</span>
                    <p><?php echo $productNames['products3']; ?></p>
                </div>
                <h1><?php echo $productNames['products3']; ?></h1>
            </div> <?php
            $productTable = "products3";
            ...
            if (mysqli_num_rows($result) > 0) { ?>
                ...
                <div class="no-data-row">
                    ...
                    <p>We don't have any products available at the moment. Please check back later.</p>
                </div> <?php
            } ?>
        </div>
    </main>
